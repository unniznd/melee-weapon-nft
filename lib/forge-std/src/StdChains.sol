...
abstract contract StdChains {
    ...
    function _getChainWithUpdatedRpcUrl(
        string memory chainAlias,
        Chain memory chain
    ...
    function _initializeStdChains() private {
        ...
        _setChainWithDefaultRpcUrl(
            "ink",
            ChainData("Ink", 57073, "https://rpc-gel.inkonchain.com")
        );
        _setChainWithDefaultRpcUrl(
            "ink_sepolia",
            ChainData(
        ...
        _setChainWithDefaultRpcUrl(
            "radius",
            ChainData("Radius", 723487, "https://rpc.radiustech.xyz")
        );
        _setChainWithDefaultRpcUrl(
            "radius_testnet",
            ChainData(
        ...
        _setChainWithDefaultRpcUrl(
            "grav",
            ChainData("Gravity", 127001, "https://mainnet-rpc.gravity.xyz")
        );
    }

    // set chain info, with priority to chainAlias' rpc url in foundry.toml
    function _setChainWithDefaultRpcUrl(
        string memory chainAlias,
        ChainData memory chain
    ) private {
